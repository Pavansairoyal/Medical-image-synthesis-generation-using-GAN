      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[500px] h-[600px] flex flex-col p-0">
          <DialogHeader className="p-6 pb-2">
            <DialogTitle>Skin Care Assistant</DialogTitle>
          </DialogHeader>
            ...
            <div className="space-y-4">
              {messages.length === 0 ? (
                <p className="text-center text-muted-foreground text-sm">
                  Ask me anything about Skin! I can help with diseases, Caring, and more....
                </p>
              ) : (
          ...
          <form onSubmit={handleSubmit} className="border-t p-4 flex gap-4">
            <Textarea
              placeholder="Ask a question about Skin Care..."
              value={input}
